...
import           Distribution.PackageDescription
                   ( TestSuiteInterface, mkPackageName, unPackageName )
...
import           Stack.Constants
                   ...
                   , defaultUserConfigPath, docDirSuffix, relDirEtc, relDirLib
...
wantedLocalPackages =
  Set.fromList . map (packageName . lpPackage) . filter lpWanted
